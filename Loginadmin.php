...
<header class="page-header header container-fluid">
		...
		<div class="description">
 		...
 		<h3>Cette partie est dédiée uniquement à l'admin!</h3><br>
	</header>
<div class="container features">
	...
	if (isset($_POST["button"]))
	{
		...
		else
		{
			if($db_found)
			{
				//on cherche dans admin 
				if ($Email != "" )
				{
					if($Password !=""){
					$sql ="SELECT * FROM admin WHERE Email LIKE '$Email' AND Mot_de_passe LIKE '$Password' ";					
					}
				...
				{
					echo '<h5>Un de vos identifiants ou les deux sont incorrects. <a href="connexionadmin.html"> Veuillez vérifier</a>! </h5>';
